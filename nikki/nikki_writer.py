...
# use QWEN  (mistral) https://huggingface.co/DavidAU/MN-WORDSTORM-pt1-RCM-Kiss-of-Madness-18.5B-Instruct-GGUF?not-for-all-audiences=true
# model_path="./models/MN-WORDSTORM-pt1-RCM-Kiss-of-Madness-18.5B-Instruct-D_AU-Q4_k_m.gguf"

# A bit cliche
# model_path="./models/Gemma-The-Writer-9B-D_AU-Q4_k_m.gguf"
...
llm = LlamaCpp(
    ...
    n_ctx=16046,  # Adjust to an optimal context size (8192 for handling large chunks)
    n_ctx_per_seq=16046,
